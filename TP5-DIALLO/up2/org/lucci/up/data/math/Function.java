package org.lucci.up.data.math;


import org.lucci.up.data.*;
/**
 * <p>
 * The function class is a facility class usable to generate figure
 * that represent mathematical curves.
 * </p>
 * @author Luc Hogie
 */
...
public abstract class Function
{
	 ...
	 * The return element is not a single number but
	 * a point. This allow the modelisation of
	...
	/**
	 * Sets the set of values on which the function is defined.
	 * Note that allow only to modelise descrete functions. This is
	 * not a problem because the goal of Up is the representation and
	 * the representing a non-discrete function is, anyway, a discrete
	 * process.
	 * @param values
	 */
	...
	/**
	 * Sets a definition interval for the function. In this
	 * interval, the definition set is made of 100 points
	 * in the interval.
	 * 
	 * @param start
	 * @param end
	...
	/**
	 * Creates a figure that is the representation of the function
	 * on its interval.
	 * @return Figure
	 */
	public Figure createFigure()
	{
		Figure pointList = new Figure();
		double[] parms = getDefinitionValues();

		if ( parms != null )
		{
			for (int i = 0; i < parms.length; ++i)
			{
				Point p = evaluate( parms[ i ] );
